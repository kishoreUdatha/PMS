"""Alembic environment for the IAM service."""
...
from iam_service import models  # noqa: F401
from iam_service.settings import settings
...
config.set_main_option(
    "sqlalchemy.url",
    settings.iam_migration_database_url or settings.iam_database_url,
)
...
# This service owns only the ``iam`` schema.
INCLUDE_SCHEMAS = {"iam"}
